<?php
namespace MartailerSliderWidget\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'martailer-slider' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'martailer-slider' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'martailer-slider' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'martailer-slider' ),
			]
		);
